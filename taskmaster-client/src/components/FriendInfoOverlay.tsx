  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full px-4 py-3 bg-primary text-white rounded-md hover:bg-primary/90 transition-colors text-base font-medium flex items-center justify-center gap-2"
      >
